<template>
  <section id="profile" class="section-card">
    <!-- MESSAGE DISPLAYS -->
<div v-if="errorMessage" class="overlay-message error">
  {{ errorMessage }}
</div>
<div v-if="successMessage" class="overlay-message success">
  {{ successMessage }}
</div>
...
<div class="auth-links">
  <a href="#" @click.prevent="showResetPassword = true; resetAuthMessages()">Forgot Password?</a>
